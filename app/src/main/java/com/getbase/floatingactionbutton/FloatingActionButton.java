        ...
        extends ImageButton
{
    ...
    private void updateCircleSize()
    {
        mCircleSize = getDimension(
                mSize == SIZE_NORMAL ? R.dimen.fab_size_normal : R.dimen.fab_size_mini);
    }
    ...
    void updateBackground()
    {
        ...
        layerDrawable.setLayerInset(3, circleInsetHorizontal + iconOffset,
                                    circleInsetTop + iconOffset, circleInsetHorizontal + iconOffset,
        ...
        shapeDrawable.setShaderFactory(new ShaderFactory()
        {
                    ...
                    int height)
            {
                return new LinearGradient(width / 2, 0, width / 2, height, new int[] {
                        ...
                        bottomStrokeColor}, new float[] {0f, 0.2f, 0.5f, 0.8f, 1f}, TileMode.CLAMP);
            }
        });
    ...
    {
        return Color.argb(Color.alpha(argb) / 2, Color.red(argb), Color.green(argb),
                          Color.blue(argb));
    }
    ...
    private int adjustColorBrightness(
            int argb,
            float factor)
    {
    ...
    public void setColorNormalResId(
            @ColorRes
            int colorNormal)
    {
    ...
    public void setColorPressedResId(
            @ColorRes
            int colorPressed)
    {
    ...
    public void setColorDisabledResId(
            @ColorRes
            int colorDisabled)
    {
            ...
            extends LayerDrawable
    {
        ...
        public TranslucentLayerDrawable(
                int alpha,
                Drawable... layers)
        {
            super(layers);
