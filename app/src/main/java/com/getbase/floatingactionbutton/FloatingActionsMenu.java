        ...
        extends ViewGroup
{
    ...
    private              AnimatorSet  mExpandAnimation        =
            new AnimatorSet().setDuration(ANIMATION_DURATION);
    ...
    private static       Interpolator sAlphaInterpolator      = new DecelerateInterpolator();
        ...
        mAddButton = new AddFloatingActionButton(context)
        {
            ...
            Drawable getIconDrawable()
            {
                ...
                final ObjectAnimator expandAnimator =
                        ObjectAnimator.ofFloat(rotatingDrawable, "rotation",
            ...
            int b)
    {
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    if (label != null) {
                        ...
                        label.layout(labelLeft, labelTop, labelsRight,
                                     labelTop + label.getMeasuredHeight());

                        AnimatorProxy labelProxy = AnimatorProxy.wrap(label);
                        labelProxy.setTranslationY(
                                mExpanded ? expandedTranslation : collapsedTranslation);
                        labelProxy.setAlpha(mExpanded ? 1f : 0f);
            ...
            case EXPAND_RIGHT:
                ...
                mAddButton.layout(addButtonX, 0, addButtonX + mAddButton.getMeasuredWidth(),
            ...
            extends ViewGroup.LayoutParams
    {
        ...
        public LayoutParams(ViewGroup.LayoutParams source)
        {
            ...
            mExpandAlpha.setInterpolator(sAlphaInterpolator);
            mCollapseDir.setInterpolator(sCollapseInterpolator);
            mCollapseAlpha.setInterpolator(sAlphaInterpolator);
